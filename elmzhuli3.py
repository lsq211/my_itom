...
class LYB:
    ...
    def xsign(self, api, data, wua, v):
        url = "http://150.158.10.200:1177/Xsign?Card=544679"
        body = {
            "data": data,
            "api": api,
            "pageId": '',
    ...
    def xsign1(self, api, data, wua, v):
        url = "http://150.158.10.200:1177/Xsign"
        body = {
            "data": data,
            "api": api,
            "pageId": '',
    ...
    def xsign2(self, api, data, wua, v):
        url = "http://150.158.10.200:18849/api/getXSign"
        body = {
            "data": data,
            "api": api,
            "pageId": '',
